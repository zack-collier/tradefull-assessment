...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<div class="container">
		...
		@endif
		<!-- if update is successful, display alert box -->
		@if (session('success'))
			<h5 class="alert alert-success">{{ session('success') }}</h5>
		@endif
		<!-- form to collect data to be updated -->
		<form id="form" action="{{ url('update') }}" method="POST">
			@csrf
			<div class="form-group mb-3">
				<label for=""><b>ID of Data to Update:</b></label><br>
				<input type="number" name="id" placeholder="Must match existing ID">
			</div>
			<div class="form-group mb-3">
				<label for=""><b>New Name:</b></label><br>
