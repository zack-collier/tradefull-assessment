...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                                ...
                                <li class="nav-item active">
                                        <a class="nav-link" href="#">Delete<span class="sr-only">(current)</a>
                                </li>
                        </ul>
                </div>
        </nav>
	...
	<div class="container">
		...
		<form id="form" action="{{ url('delete') }}" method="POST">
			@csrf
			<div class="form-group mb-3">
				<label for=""><b>ID of Data to Delete:</b></label><br>
				<input type="text" name="id" placeholder="Must match existing ID">
			</div>
			<div class="form-group mb-3">
